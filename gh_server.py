...
def llm_call():
    ...
    json_values = []
    answer = ""
    if router_output in "filter_units": 
    ...
    if router_output in "filter_panels":
    ...
    if router_output in "table_summary":
    ...
    if router_output in "recommendations":
    ...
    if router_output in "component_recommendations":
